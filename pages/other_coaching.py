...
class load_other_coaching_page:
    ...
    def comparison_line_plot_tc_cases_rv(self, feature):
        try:
            ...
            logging.info(f"Entered comparison_line_plot_tc_cases_rv ")
            ...
            logging.info(f"Completed comparison_line_plot_tc_cases_rv ")
    ...
    def draw_revenue_trend_lines(self):
        try:
            logging.info(f"Entered draw_revenue_trend_lines")
            ...
            fig.update_xaxes(showline=True, linewidth=2, linecolor='black',)
            logging.info(f"comepleted draw_revenue_trend_lines")
            return fig
        except Exception as e:
            raise CustomException(e, sys) from e
...
def update_other_coaching_page(selected_division):
    try:
        ...
        logging.info(f" {'='* 20} Update update_other_coaching_page started. {'='*20} ")
