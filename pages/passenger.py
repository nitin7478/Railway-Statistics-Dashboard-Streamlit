...
class plot_passenger_graphs:
    ...
    def comparison_line_plot_pass(self, feature):
        try:
            logging.info(f"entered  comparison_line_plot_pass")
            ...
            logging.info(f"completed  comparison_line_plot_pass")
    ...
    def plot_pie_chart(self,):
        try:
            ...
            logging.info(f"successfully completed  plot_pie_chart")
            return fig
        except Exception as e:
            raise CustomException (e,sys) from e
...
def update_passenger_page(selected_division):
    try:
        logging.info(f" {'='* 20} update_passenger_page log started {'='*20} ")
