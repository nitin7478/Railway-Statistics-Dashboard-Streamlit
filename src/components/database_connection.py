...
class handle_database:
    ...
    def load_dataframe(self, selected_division, selected_database):
        try:
            logging.info(f"entered load_dataframe from database_connection for div : {selected_division} for db : {selected_database}")
            ...
            logging.info(f"completed load_dataframe from database_connection for div : {selected_division} for db : {selected_database}")
